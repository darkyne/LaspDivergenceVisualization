...
#Set4 10nodes, 6experiments, 50iterations, 60sec duration

#This Script launchs 10nodes that will remove elements and measure convergence time, CRDT memory size and number of messages received
...
sourcePath=Memoire/AppsToLaunch/Set4/measure
...
do
	...
	then
	duration=200
	echo "duration set to 200s for exp5 and exp6"
	fi
