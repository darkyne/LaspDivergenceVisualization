...
#Set6 20nodes, 6experiments, 50iterations, 60sec duration

#This Script launchs 20nodes that will remove elements and measure convergence time, CRDT memory size and number of messages received
...
sourcePath=Memoire/AppsToLaunch/Set6/measure
