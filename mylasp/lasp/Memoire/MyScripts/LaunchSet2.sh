...
#Set2 5nodes, 6experiments, 50iterations, 60sec duration

#This Script launchs 5nodes that will remove elements and measure convergence time, CRDT memory size and number of messages received
...
sourcePath=Memoire/AppsToLaunch/Set2/measure
